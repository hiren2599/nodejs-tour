...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGxwMjU5OSIsImEiOiJjazg5NmQ2NzQwM2U5M29tcDZmYTVtZ3ZlIn0.QFg9zGy98AhvhhpUY52hLA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/hlp2599/ck896oqvj2tmf1iqvz2opu6n6',
    scrollZoom: false // center: [72.511788, 23.036345],
    // zoom: 10
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // loc.coordinates.reverse();
    //Add marker
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Try logging out again.');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Data Successfully Updated")); //   window.setTimeout(() => {
              //     location.assign('/');
              //   }, 1500);
            }
...
var stripe = Stripe('pk_test_wPQBO5c91QLjg4faWCMrBCLx000JrwCGsl');
